...
(isset($context["origin"]) || array_key_exists("origin", $context))) ? (_twig_default_filter(($context["origin"] ?? null), "none")) : ("none"))]));
    ...
    {
        return new Source("", "@PrestaShop/Admin/Module/Includes/grid_notification_update.html.twig", "/var/www/html/bredala/bredala/src/PrestaShopBundle/Resources/views/Admin/Module/Includes/grid_notification_update.html.twig");
    }
}
