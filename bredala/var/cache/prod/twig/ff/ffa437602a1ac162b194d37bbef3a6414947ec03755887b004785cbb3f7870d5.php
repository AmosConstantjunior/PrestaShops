...
class __TwigTemplate_5865019be708470bdf6f61698c1986a3db69fdc01508e9e4744bc9fc0143a0a9 extends \Twig\Template
{
...
($context["app"] ?? null), "request", []), "query", []), "get", [0 => "id_cms_category"], "method")]), "desc" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Add new page", [], "Admin.Design.Help"), "icon" => "add_circle_outline"]];
  ...
  <div class=\"row\">
    ...
    public function block_cms_category_grid($context, array $blocks = [])
    {
      ...
      <div class=\"col\">";
        // line 57
        $this->loadTemplate("@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", "@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", 57, "1092940419")->display(twig_array_merge($context, ["grid" => ($context["cmsCategoryGrid"] ?? null)]));
        // line 65
        echo "      </div>
    </div>";
    }
  ...
  <script src=\"";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", "/var/www/html/bredala/bredala/src/PrestaShopBundle/Resources/views/Admin/Improve/Design/Cms/index.html.twig");
    }
}


/* @PrestaShop/Admin/Improve/Design/Cms/index.html.twig */
class __TwigTemplate_5865019be708470bdf6f61698c1986a3db69fdc01508e9e4744bc9fc0143a0a9___1092940419 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        parent::__construct($env);
